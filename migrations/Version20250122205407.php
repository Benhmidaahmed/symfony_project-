 ...
 */
final class Version20250122205407 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment CHANGE date date DATE NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointment CHANGE date date DATETIME NOT NULL');
    }
}
